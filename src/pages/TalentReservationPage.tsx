  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="#" className="text-white/80 hover:text-white text-sm">Programs</a>
              <a href="#" className="text-white/80 hover:text-white text-sm">For Employers</a>
              <a href="#" className="text-white/80 hover:text-white text-sm">Apply Now</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 text-primary">Reservation Confirmation</h1>
          <p className="text-gray-600">
            You've successfully reserved candidates from the SkillTrade talent pool.
          </p>
        </div>
            ...
            <Card>
              <CardHeader className="bg-green-50">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Reference #STR-{Math.floor(Math.random() * 10000).toString().padStart(4, '0')}
                    </CardDescription>
                  </div>
              ...
              <CardContent className="pt-6">
                <div className="space-y-6">
                  ...
                  {bulkReservation ? (
                    <div>
                      <h3 className="font-medium text-lg mb-2">Talent Allocation</h3>
                      <div className="p-4 bg-gray-50 rounded-md">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          <div>
                            <div className="text-sm text-gray-500">Current Students</div>
                            <div className="font-medium text-lg">{callDetails.activeStudentCount}</div>
                          </div>
                          <div>
                            <div className="text-sm text-gray-500">Prospective Students</div>
                            <div className="font-medium text-lg">{callDetails.prospectiveCount}</div>
                          </div>
                        </div>
                        ...
                        <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden mb-1">
                          <div 
                            ...
                            style={{ width: `${(callDetails.activeStudentCount / (callDetails.activeStudentCount + callDetails.prospectiveCount)) * 100}%` }}
                          ></div>
                        </div>
                        
                        <div className="flex justify-between text-xs text-gray-500 mb-4">
                          <span>Current: {Math.round((callDetails.activeStudentCount / (callDetails.activeStudentCount + callDetails.prospectiveCount)) * 100)}%</span>
                          <span>Prospective: {Math.round((callDetails.prospectiveCount / (callDetails.activeStudentCount + callDetails.prospectiveCount)) * 100)}%</span>
                        </div>
                        
                        <div className="text-sm text-center text-gray-700">
                          Total: <span className="font-medium">{callDetails.activeStudentCount + callDetails.prospectiveCount} candidates</span>
                        </div>
                      </div>
                    </div>
                  ) : (
                          ...
                          <div key={student.id} className="p-3 border rounded-md flex justify-between items-center">
                            ...
                            <div className="text-right text-sm">
                              ...
                              <div className="flex items-center justify-end text-primary/80">
                                ...
                                <span>{student.isProspective ? 'Prospective' : `Available ${student.availableDate}`}</span>
                              </div>
                            </div>
                          </div>
                        ))}
              ...
              <CardContent className="pt-6">
                <div className="space-y-6">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-gray-500">Source: SkillTrade Employer Survey 2024</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      With SkillTrade Sponsored Talent, you can build a custom talent pipeline tailored to your specific needs, 
