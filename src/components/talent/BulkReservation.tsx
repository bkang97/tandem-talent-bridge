      ...
      <Card className="border-primary/20 shadow-sm">
        <CardHeader className="pb-4 bg-primary/5 border-b border-primary/20">
          ...
          <p className="text-sm text-gray-600">
            Tell us your requirements and we'll match you with available
            candidates
          </p>
        </CardHeader>
              ...
              {gapAmount > 0 && (
                <p className="mt-3 text-sm text-gray-700">
                  <strong className="text-amber-700">
                    {gapAmount} more candidates needed
                  </strong>{" "}
                  to fulfill your request. Consider Sponsorship to close this
                  gap.
                </p>
              )}
            </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-xs text-gray-600">
                      Fulfills your exact hiring needs with targeted talent
                    </span>
                  </div>
                </div>
                <Button
